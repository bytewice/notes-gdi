...
WHERE departamento = 'Books' AND salario > 100000;

# trago os funcionarios que trabalham no departamento de filme ou no de roupas
SELECT nome FROM funcionarios
WHERE departamento = 'Filmes' OR departamento = 'Roupas';

#trazer os dados dos funcionaros do sexo feminino que trabalham no departamento de beleza
SELECT * FROM funcionarios
WHERE sexo = 'Feminino' AND departamento = 'Computadores';

#trazer os funcionarios do sexo masculino ou os funcionarios que trabalham no setor de jardim
SELECT nome FROM funcionarios
